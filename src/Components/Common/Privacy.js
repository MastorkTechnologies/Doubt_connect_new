...
function Privacy() {
  ...
  const Emailaddress = 'customercare@doubtconnect.in';
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to DoubtConnect, CIBA, 6th Floor,Agnel
                Technical Complex, Sector 9A, Navi Mumbai, Maharashtra 400703.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to DoubtConnect, accessible from{" "}
                <a
                  href="https://www.doubtconnect.in"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.doubtconnect.in
                </a>
              </p>
            </li>
            <li>
