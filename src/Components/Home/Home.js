...
;
  ...
  return (
    <Fragment>
      {displayVideoOverlay && (
        <VideoOverlay
          handleCloseVideoOverlay={handleCloseVideoOverlay}
          vId={vId}
        ></VideoOverlay>
      )}
      ...
      >
        <div className="Home-intro">
          <div className="Home-intro-left">
            <h1 className="Heading">
              Your after school<br></br> <span>learning partner!</span>
            </h1>
            <p>
              Plug and Play with Schools - Easy SDK/API integration with
              School's Learning Management Systems.
            </p>
            <button
            ...
            >
              ...
              >
                <path
                  d="M1 8.10388H13.9545"
                  stroke="white"
                  stroke-width="1.85065"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M7.47754 1.62659L13.9548 8.10385L7.47754 14.5811"
                  stroke="white"
                  stroke-width="1.85065"
                  stroke-linecap="round"
                  stroke-linejoin="round"
        ...
        <div className="whats-next">
          ...
          ></img>
          <p className="whats-small">
            Book your free demo
            <br /> with us by just filling <br />
            up a few details
          </p>

          <svg
            className="down-svg-arrow"
            width="25"
            height="37"
            viewBox="0 0 35 47"
            fill="none"
          ...
          >
            <path
              d="M0.249999 29.5176L4.41875 25.4926L14.625 35.6988L14.625 0.767577L20.375 0.767577L20.375 35.6988L30.5812 25.4926L34.75 29.5176L17.5 46.7676L0.249999 29.5176Z"
              fill="#52ACFF"
            />
          </svg>
          ...
          <p className="whats-big">
            Book your free demo
            <br /> with us by just filling <br />
            up a few details
          </p>
          <svg
            className="left-svg-arrow"
            width="49"
            height="49"
            viewBox="0 0 49 49"
            fill="none"
          ...
          >
            <path
              d="M28.5846 36.75L25.7263 33.7896L32.9742 26.5417H8.16797V22.4583H32.9742L25.7263 15.2104L28.5846 12.25L40.8346 24.5L28.5846 36.75Z"
              fill="#52ACFF"
            />
          </svg>
        ...
        <h1 className="Heading Heading-2">
          How will we <span>help</span> you?
        </h1>
        ...
        <div className="Help-section">
          ...
          <div
            className="Help-container Tdown"
          ...
          >
            ...
            <p className="Help-container-para">
              We have over 150,000 + minutes of content on the platform which
              students can watch and learn better
            </p>
          </div>
          ...
          >
            ...
            >
              <path
                d="M19.8164 13.5781V3.70312H9.94141V11.1094H2.53516V25.9219H27.2227V13.5781H19.8164ZM12.4102 6.17188H17.3477V23.4531H12.4102V6.17188ZM5.00391 13.5781H9.94141V23.4531H5.00391V13.5781ZM24.7539 23.4531H19.8164V16.0469H24.7539V23.4531Z"
                fill="#DA5E74"
              />
            </svg>
            <h2>Mentorship sessions with industry leaders</h2>
            <p className="Help-container-para">
              Weekly mentorship sessions with top corporate leaders, government
              officials and executives to motivate students
            </p>
          </div>
          ...
          <div className="Floating-container --8--">
            ...
            >
              <path
                d="M14.2162 15.8948V14.2876C14.2162 13.4351 13.8775 12.6175 13.2747 12.0147C12.6719 11.4118 11.8543 11.0732 11.0017 11.0732H4.57284C3.72032 11.0732 2.90271 11.4118 2.29989 12.0147C1.69706 12.6175 1.3584 13.4351 1.3584 14.2876V15.8948"
                stroke="#52ACFF"
                stroke-width="1.60722"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M7.78769 7.85864C9.56297 7.85864 11.0021 6.41948 11.0021 4.64419C11.0021 2.8689 9.56297 1.42975 7.78769 1.42975C6.0124 1.42975 4.57324 2.8689 4.57324 4.64419C4.57324 6.41948 6.0124 7.85864 7.78769 7.85864Z"
                stroke="#52ACFF"
                stroke-width="1.60722"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <div className="Floating-container --22--">
            ...
            >
              <path
                d="M17.07 2.93L15.66 4.34C17.1586 5.84245 18.0001 7.87793 18 10C18 14.42 14.42 18 10 18C5.58 18 2 14.42 2 10C2 5.92 5.05 2.56 9 2.07V4.09C6.16 4.57 4 7.03 4 10C4 13.31 6.69 16 10 16C13.31 16 16 13.31 16 10C16 8.34 15.33 6.84 14.24 5.76L12.83 7.17C13.55 7.9 14 8.9 14 10C14 12.21 12.21 14 10 14C7.79 14 6 12.21 6 10C6 8.14 7.28 6.59 9 6.14V8.28C8.4 8.63 8 9.26 8 10C8 11.1 8.9 12 10 12C11.1 12 12 11.1 12 10C12 9.26 11.6 8.62 11 8.28V0H10C4.48 0 0 4.48 0 10C0 15.52 4.48 20 10 20C15.52 20 20 15.52 20 10C20 7.24 18.88 4.74 17.07 2.93Z"
                fill="#52ACFF"
              />
            </svg>
          ...
          >
            ...
            <h2>
              Weekly curated<br></br> assessments by top<br></br> subject matter
              experts
            </h2>
            <p className="Help-container-para">
              Weekly assessments on the platform to track every student's
              progress and award flags
            </p>
          </div>
        ...
        <h1 className="Heading Heading-2">
          Our <span>Impact</span> & <span>Metrics</span>
        </h1>
        ...
        <div className="Metrics">
          <div>
            <h1>20000+</h1>
            <p>
              Users have used the platform to solve their doubts since the
              launch
            </p>
          </div>
          <div>
          ...
          <div>
            <h1>100,000</h1>
            <p>
              minutes of learning conducted with over{" "}
              <span style={{ color: "black", fontWeight: "600" }}>60,000</span>{" "}
              doubts solved
            </p>
          </div>
        </div>
        ...
        <div className="testimonials">
          <div className="testimonial">
            <div className="testimonial-comment">
              ...
              <p className="testimonial-big">
                I was able to get my doubt solved within minutes. Interface was
                student friendly & easy to navigate. I understood the solution
                clearly and easily.
              </p>
              <p className="testimonial-small">
                I was able to get my doubt solved within minutes. The interface
                was student friendly & easy to navigate. Tutor assigned to me
                was very good. I understood the solution clearly and easily.
              </p>
            ...
            <div className="testimonial-img-container">
              ...
              <img
                ...
                src={home_testi_1_mobile}
              ></img>
              <button
                className="play-button"
                onClick={() => handleDisplayVideoOverlay("G-Wbqx7sQgQ")}
              >
                <svg
                  width="36"
                  height="36"
                ...
                >
                  ...
                  />
                  <path
                    d="M24.572 17.2454C25.1338 17.5697 25.1338 18.3804 24.572 18.7047L15.0929 24.1774C14.5312 24.5017 13.8291 24.0963 13.8291 23.4477L13.8291 12.5024C13.8291 11.8538 14.5312 11.4484 15.0929 11.7727L24.572 17.2454Z"
                    fill="#52ACFF"
                  />
                </svg>
              </button>
          ...
          <div className="testimonial">
            <div className="testimonial-img-container">
              ...
              <img
                className="testimonial-small"
                src={home_testi_2_mobile}
              ></img>
              <button
                className="play-button"
                onClick={() => handleDisplayVideoOverlay("ao2KAF16Crk")}
              >
                <svg
                  width="36"
                  height="36"
            ...
            <div className="testimonial-comment">
              <span className="quote">&ldquo;</span>
              <p className="testimonial-big">
                It was fantastic! My session was just awesome. All my doubts
                were resolved by the tutor's excellent explanation of the
                concept.
              </p>
              <p className="testimonial-small">
                It was fantastic! My session was just awesome. All my doubts
        ...
        <div ref={form} className="fill-details">
          <div className="fill-details-left">
            <h3>
              Let us help you get <span>better learning</span> outcomes for your{" "}
              <span>School!</span>
            </h3>
