        ...
        <div className="For-students-how-left">
          <div>
            <h1 className="For-students-heading">
              Providing solutions for <span>HC Verma</span> to <br />
              <span>RD Sharma</span>!<br />
              We've got it all covered!
            </h1>
          </div>
          <p>
            DoubtConnect, the leading live doubt solving app! Experience instant
            doubt solving with expert tutors, one-on-one on a video call in just
            60 seconds!
          </p>
