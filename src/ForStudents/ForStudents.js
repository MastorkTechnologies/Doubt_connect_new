    ...
    <div className="ForStudents">
      ...
      <div className="For-students-how">
        <div className="For-students-how-left">
          <div>
            <h1 className="For-students-heading">
              <span>DoubtConnect</span> a day. Keeps all your
              <br />
              <span>Doubts away!</span>
            </h1>
          </div>
          <p>
            Get your doubts solved now on a 1-1 live session by getting
            connected with a tutor instantly! (psst.. just within 40 seconds)
          </p>

          <Link to="https://forms.gle/YuMS2ajC7TZcAN6d9" target="_blank">
            Download Now !
          </Link>
        </div>
        <div className="For-students-how-right">
          ...
          <button
            ...
            onClick={() => handleDisplayVideoOverlay("WA61tUNIZwM")}
          >
            <svg
              width="36"
              height="36"
      ...
      <b>
        <span className="For-students-heading">
          How <span>DoubtConnect</span> works?
        </span>
      </b>
      <div className="how-we-work">
        <div>
          <img src={how1}></img>
          <p>
            Take a picture of your doubt and upload it on our app and select the
            subject and chapter your doubt belongs to.
          </p>
        </div>
        <svg
        ...
        <div>
          <img src={how2}></img>
          <p>
            Our AI-enabled proprietary algorithm finds the best suited-tutors
            and gives you up to 3 tutors to choose from.
          </p>
        </div>
        <svg
          className="left-svg-arrow"
        ...
        <div>
          <img src={how3}></img>
          <p>
            Pick your preferred tutor and get instantly connected with them, in
            40 seconds for a 1-1 live sesh :)
          </p>
        </div>
      ...
      <div className="For-student-steps">
        ...
        <div
          className="For-student-step Tdown"
        ...
        >
          <div>
            ...
            >
              <path
                d="M31.2207 5.86328H4.83594C4.05842 5.86328 3.31274 6.17215 2.76295 6.72194C2.21317 7.27173 1.9043 8.0174 1.9043 8.79492V27.8506C1.9043 28.6281 2.21317 29.3738 2.76295 29.9236C3.31274 30.4734 4.05842 30.7822 4.83594 30.7822H31.2207C31.9982 30.7822 32.7439 30.4734 33.2937 29.9236C33.8435 29.3738 34.1523 28.6281 34.1523 27.8506V8.79492C34.1523 8.0174 33.8435 7.27173 33.2937 6.72194C32.7439 6.17215 31.9982 5.86328 31.2207 5.86328ZM4.83594 27.8506V8.79492H16.5625V27.8506H4.83594ZM31.2207 27.8506H19.4941V8.79492H31.2207V27.8506ZM20.96 13.9253H29.7549V16.124H20.96V13.9253ZM20.96 17.5898H29.7549V19.7886H20.96V17.5898ZM20.96 21.2544H29.7549V23.4531H20.96V21.2544Z"
                fill="#8B62B6"
              />
            </svg>
            <h2>Learning Journey</h2>
            <p>
              Our AI helps you track your learning outcomes by constantly
              assessing your intelligence with assessments prepared by our
        ...
        <Link to="https://forms.gle/YuMS2ajC7TZcAN6d9" target="_blank">
          {" "}
          Put an end to all your doubts NOW!
          <svg
            width="22"
            height="22"
            viewBox="0 0 49 49"
      ...
      <b>
        <span className="For-students-heading">
          Our <span>Metrics</span>
        </span>
      </b>
      <div className="Metrics">
        <div>
          <b>
            <span class="Heading Heading-2">
              <span>20000+</span>
            </span>
          </b>
          <p>
            Users have used the platform to solve their doubts since the launch
          </p>
        </div>
        <div>
          <b>
      ...
      <b>
        <span className="For-students-heading">
          What do our <span>Users</span> say ?
        </span>
      </b>
      <div className="testimonials">
        <div className="testimonial">
          <div className="testimonial-comment">
            ...
            <p className="testimonial-big">
              I was perplexed with one of the topics in math for days, but the
              doubt session with the tutor cleared it out in minutes. The idea
              and the implementation are both <span>perfect</span>. Thank you so
              much <span>DC</span>!!
            </p>
            <p className="testimonial-small">
              It was wonderful. His instruction was simple to understand, and
              the teacher was extremely kind. I would recommend this app to all
          ...
          <div className="testimonial-img-container">
            ...
            <img
              ...
              src={forstudents_testi_2_mobile}
            ></img>
            <button
              className="play-button"
        ...
        <div className="testimonial">
          <div className="testimonial-img-container">
            <img
              className="testimonial-small"
              src={forstudents_testi_3_mobile}
            ></img>
          ...
          <div className="testimonial-comment">
            <span className="quote">&ldquo;</span>
            <p className="testimonial-big">
              It was a <span>great experience!</span> The tutor explained the
              sum very well and tackled the same problem in different methods
              which helped in my <span>understanding</span>. The interface is
              very easy to navigate for first time users also.
            </p>
            <p className="testimonial-small">
              It was a wonderful and easy session. The instructor thoroughly
              discussed the subject and answered all my questions about it.
            </p>
        ...
        <div className="testimonial" style={{ alignItems: "unset" }}>
          ...
          <div className="testimonial-3">
            <img
              className="testimonial-big"
              src={forstudents_testi_4_mobile}
            ></img>
            <button
              className="play-button"
              onClick={() => handleDisplayVideoOverlay("_46MZa2LhGs")}
            >
              <svg
                width="36"
                height="36"
          ...
          <div className="testimonial-3-comment">
            <span className="quote">&ldquo;</span>
            <p className="testimonial-big">
              I had a doubt with algebra . My friend had suggested this app....
              It proved to be really helpful.
            </p>
            <p className="testimonial-small">
              I had a doubt with algebra . My friend had suggested this app....
              It proved to be really helpful.
        ...
        <div>
          <b>
            <span className="Heading Heading-2">
              <span style={{ color: "black", fontSize: "2.3rem" }}>
                Still here? Looks like you definitely have some doubts.
                <br />
